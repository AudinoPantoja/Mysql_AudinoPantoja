...
-- Crear la tabla de usuarios (sin tabla usersRoles)
CREATE TABLE users (
    id INT(20) PRIMARY KEY AUTO_INCREMENT,
...
-- Crear la tabla de personas (incluye el campo isSupplier)
CREATE TABLE people (
    id INT(20) PRIMARY KEY AUTO_INCREMENT,
    idUser INT(20),
...
CREATE TABLE purchaseOrders (
    ...
    createdAt DATETIME,
    updatedAt DATETIME,
    FOREIGN KEY (idSupplier) REFERENCES people(id),
